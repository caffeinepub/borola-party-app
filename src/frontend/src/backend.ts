...
import type { Candidate as _Candidate, ExternalBlob as _ExternalBlob, Mla as _Mla, Supporter as _Supporter, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCandidate(arg0: string, arg1: Candidate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCandidate(arg0, await to_candid_Candidate_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addMla(arg0: string, arg1: Mla): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMla(arg0, await to_candid_Mla_n11(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addSupporter(arg0: Supporter): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSupporter(await to_candid_Supporter_n12(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteCandidate(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCandidate(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteMla(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteMla(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteSupporter(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteSupporter(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMlas(): Promise<Array<Mla>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMlas();
    ...
    async getAllSupporters(): Promise<Array<Supporter>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSupporters();
    ...
    async updateCandidate(arg0: string, arg1: Candidate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCandidate(arg0, await to_candid_Candidate_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMla(arg0: string, arg1: Mla): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMla(arg0, await to_candid_Mla_n11(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSupporter(arg0: string, arg1: Supporter): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSupporter(arg0, await to_candid_Supporter_n12(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Candidate_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Candidate): Promise<Candidate> {
...
async function from_candid_Mla_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Mla): Promise<Mla> {
    return await from_candid_record_n16(_uploadFile, _downloadFile, value);
}
async function from_candid_Supporter_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Supporter): Promise<Supporter> {
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Candidate>): Promise<Array<Candidate>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Candidate_n15(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Mla>): Promise<Array<Mla>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Mla_n20(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Supporter>): Promise<Array<Supporter>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Supporter_n22(_uploadFile, _downloadFile, x)));
}
async function to_candid_Candidate_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Candidate): Promise<_Candidate> {
...
async function to_candid_Mla_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Mla): Promise<_Mla> {
    return await to_candid_record_n9(_uploadFile, _downloadFile, value);
}
async function to_candid_Supporter_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Supporter): Promise<_Supporter> {
